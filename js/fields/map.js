(function( $ ) {
	...
	function initializeMap( mapInstance ) {
		var searchInput = mapInstance.find( '.skeleton-map-search' );
		var mapCanvas = mapInstance.find( '.skeleton-map' );
		var latitude = mapInstance.find( '.skeleton-map-latitude' );
		var longitude = mapInstance.find( '.skeleton-map-longitude' );
