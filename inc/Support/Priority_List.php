...
/**
 * This class derived from Zend\Stdlib\PriorityList
 * by Zend Framework (http://framework.zend.com/)
 *
	...
	public function toArray( $flag = self::EXTR_DATA ) {
		...
		return array_map(
			function ( $item ) use ( $flag ) {
				return ($flag == Priority_List::EXTR_PRIORITY) ? $item['priority'] : $item['data'];
			},
			$this->items
		);
	}
